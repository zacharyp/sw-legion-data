...
export var units = unitsImport;
export var unitsRecord = unitsRecordImport;
export var upgrades = upgradesImport;
export var upgradesRecord = upgradesRecordImport;
export var commandCards = commandCardsImport;
export var sources = sourcesImport;
export var keywords = keywordsImport;
