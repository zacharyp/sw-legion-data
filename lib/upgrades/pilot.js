...
var upgrades = [
    {
        ...
        keywords: ['Arsenal 2'],
        description: '[action] Until the end of your activation, you gain [Arsenal 2]',
    },
    {
        ldf: 'wedgeantilles',
        name: 'Wedge Antilles',
        ...
        keywords: ['Full Pivot'],
        description: '[action] Until the end of your activation, you gain [Full Pivot].',
    },
    {
    ...
    },
    {
        ...
        factionRestrictions: ['imperial'],
        unitTypeRestrictions: ['Ground Vehicle'],
        description: 'Imperial only. Ground Vehicle only. You gain "[Surge Attack]: [Hit]"',
    },
    {
        ldf: 'ryderazadi',
        name: 'Ryder Azadi',
        ...
        description: 'Rebel only. Repulsor Vehicle only. While performing a move, increase or decrease your maximum speed by 1.',
    },
    {
    ...
    },
    {
        ...
        keywords: [],
        description: "While you or a friendly clone trooper unit at range 1 and in line of sight attacks or defends, you and that units can spend each other's aim,dodge and surge tokens.  During the End Phase ready this card.",
    },
    {
        ldf: 'aaylasecura',
        name: 'Aayla Secura',
    ...
    },
    {
        ...
        keywords: [],
        description: 'free action: until the end of you activation, you gain [Agile 2]',
    },
    {
        ldf: 'lokdurd',
        name: 'Lok Durd',
        ...
        keywords: [],
        description: 'You lose [AI: Attack], even while this card is exhausted. free action: Until the end of your activation, each of your weapons gains [Suppressive]',
    },
    {
