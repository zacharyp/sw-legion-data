...
const units: Unit[] = [
  ...
  },
  {
    ...
    keywords: ['Full Pivot', 'Reposition', 'Sentinel'],
    weapons: [
      {
        name: 'Unarmed',
        range: { from: 0 },
  ...
  },
  {
    ...
    speed: 0,
    slots: ['Comms', 'Generator'],
    keywords: ['Full Pivot', 'Sentinel', 'Stationary'],
    weapons: [
      {
        name: 'Unarmed',
        range: { from: 0 },
  ...
  },
  {
    ...
    speed: 1,
    slots: ['Comms'],
    keywords: ['AI: Attack, Move', 'Generator 1', 'Shielded', 'Wheel Mode'],
    weapons: [
      {
  ...
  },
  {
    ...
    surge: { attack: 'hit' },
    speed: 1,
    slots: ['Armament', 'Comms', 'Training'],
    keywords: ['Armor 1', 'Relentless', 'Reposition', 'Spur', 'Unhindered'],
    weapons: [
      {
