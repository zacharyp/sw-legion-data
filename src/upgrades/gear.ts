...
const upgrades: Upgrade[] = [
  ...
  },
  {
    ...
    points: 8,
    description:
      "You gain [Card Action] Spotter 1 (Choose 1 friendly unit at range 1. That unit gains 1 aim token.) B1 Battle Droids can ignore this card's Gear upgrade icon requirement.",
    keywords: ['Spotter 1'],
  },
  {
    ldf: 'jt12jetpacks',
    ...
    points: 10,
    description:
      'While equipped to Clone Captain Rex, reduce this cards points by 5.  You gain [Jump 2]',
    restrictions: [
      {
